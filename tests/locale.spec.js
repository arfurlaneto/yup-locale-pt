...
describe('locale', () => {
  ...
  it('should return localized messages for string group', async () => {
    ...
    try {
      ...
      expect(err.errors[6]).toStrictEqual('trimField não deve conter espaços adicionais antes nem depois');
  ...
  it('should return localized messages for number group', async () => {
    ...
    try {
      ...
      expect(err.errors[1]).toStrictEqual('maxField dever menor ou igual a 10');
